...
pub struct Registry<const N: usize> {
    ...
    userv_data: Grant<UserspaceServiceGrant, UpcallCount<1>, AllowRoCount<0>, AllowRwCount<3>>,
}

impl<const N: usize> Registry<N> {
    pub fn new(grant_data: Grant<UserspaceServiceGrant, UpcallCount<1>, AllowRoCount<0>, AllowRwCount<3>>) -> Registry<N> {
        Registry {
